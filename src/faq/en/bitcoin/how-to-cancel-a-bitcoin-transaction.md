...
Therefore, before attempting to cancel a Bitcoin transaction check whether it received any confirmations. Metaegg DeFi displays unconfirmed transactions with 'pending' status. As soon as transaction status changes to 'sending' the transaction may not be canceled.
...
At this point, Metaegg DeFi doesn't provide this feature but is likely to add it in the future.
