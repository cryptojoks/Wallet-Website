# How to use DeFi with Metaegg DeFi
...
Metaegg DeFi is one of the few mobile-based cryptocurrency wallets that provides an ability to connect to any DeFi service built on top of Ethereum or Binance Smart Chain blockchains using an open WalletConnect protocol.

Take the following steps to use Metaegg DeFi wallet with a DeFi service:
...
3. Open the Metaegg DeFi wallet app and navigate to the Settings tab.
